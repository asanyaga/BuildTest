...
namespace Distributr.WPF.Lib.Impl.Services.Sync.MappingToEntities.Impl
{
   public class DTOToEntityMapping : IDTOToEntityMapping
   {
       ...
       private IPurchasingClerkRepository _purchasingClerkRepository;
       ...
       public static  void SetupAutomapperMappings()
       {
           ...
           Mapper.CreateMap<ProductGroupDiscountDTO, ProductGroupDiscount>()
               ...
               .AfterMap(AfterMapAction);
           Mapper.CreateMap<ProductGroupDiscountItemDTO, ProductGroupDiscount.ProductGroupDiscountItem>()
               .ConstructUsing((ProductGroupDiscountItemDTO x) => new ProductGroupDiscount.ProductGroupDiscountItem(x.MasterId))
               .AfterMap(AfterMapAction);
       ...
       public Outlet Map(OutletDTO dto)
       {
           ...
           var shippingAddresses = dto.ShippingAddresses.Select(n => Map(n)).ToList();
       ...
       public ProductGroupDiscount.ProductGroupDiscountItem Map(ProductGroupDiscountItemDTO dto, Guid id)
       {
           if (dto == null) return null;
           var productGroupDiscountItem = Mapper.Map<ProductGroupDiscountItemDTO, ProductGroupDiscount.ProductGroupDiscountItem>(dto);
           productGroupDiscountItem.Product = new ProductRef {ProductId = dto.ProductMasterId};
           productGroupDiscountItem._Status = EntityStatus.New; 
           return productGroupDiscountItem;
       }
       ...
       public ProductGroupDiscount Map(ProductGroupDiscountDTO dto)
       {
           ...
           productGroupDiscount.GroupDiscountItems = dto.GroupDiscountItems.Select(n => Map(n, n.MasterId)).ToList();
