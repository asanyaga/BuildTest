...
{
    public class DistributrConfigService : ConfigService , IConfigService
    {
        ...
        {
            return _configRepository.GetClientApplication(VirtualCityApp.Ditributr).Select(s => new ClientApplication
                                                                                                    {
