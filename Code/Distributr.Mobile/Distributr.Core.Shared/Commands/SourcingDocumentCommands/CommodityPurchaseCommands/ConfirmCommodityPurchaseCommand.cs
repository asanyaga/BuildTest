...
{
    public class ConfirmCommodityPurchaseCommand :  ConfirmCommand
    {
        public ConfirmCommodityPurchaseCommand()
        {
        }
        ...
        {
            get { return CommandType.ConfirmCommodityPurchase.ToString(); }
        }
    }
}
