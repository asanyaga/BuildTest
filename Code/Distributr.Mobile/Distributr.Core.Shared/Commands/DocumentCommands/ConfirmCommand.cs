...
{
  public abstract  class ConfirmCommand : DocumentCommand
    {
      public ConfirmCommand()
      {
          
      }
      protected ConfirmCommand(Guid commandId, Guid documentId, Guid commandGeneratedByUserId, Guid commandGeneratedByCostCentreId, 
