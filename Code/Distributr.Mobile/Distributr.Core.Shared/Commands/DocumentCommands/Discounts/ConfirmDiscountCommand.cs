...
{
    public class ConfirmDiscountCommand : ConfirmCommand
    {
        public ConfirmDiscountCommand()
        {
            
        }
        public ConfirmDiscountCommand(Guid commandId, Guid documentId, 
        ...
        {
            get { return CommandType.ConfirmDiscount.ToString(); }
        }
    }
}
