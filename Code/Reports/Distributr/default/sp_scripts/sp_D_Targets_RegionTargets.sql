/****** Object:  StoredProcedure [dbo].[sp_D_Targets_RegionTargets]    Script Date: 07/24/2013 08:51:32 ******/
DROP PROCEDURE [dbo].[sp_D_Targets_RegionTargets]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_D_Targets_RegionTargets]
(
...
WHERE     (distributr.CostCentreType = 2) 
           ...
           AND(CONVERT(NVARCHAR(50), reg.id)LIKE ISNULL(@regionId, N'%'))

--  exec   [dbo].[sp_D_Targets_RegionTargets]    @targetId='ALL', @countryId='ALL',@regionId='ALL'
