DROP PROCEDURE [dbo].[sp_D_DB_Routes_PerRegion]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_D_DB_Routes_PerRegion]
(
...
WHERE     (Outlet.CostCentreType = 5) 
 ...
 --  Exec  [dbo].[sp_D_DB_Routes_PerRegion]   @regionId='ALL',@countryId='ALL',@HqId='ALL',@distributorId='ALL',@routesId='ALL',@salesmanId='ALL',@outletId='ALL',@startDate ='1-Jan-2013',@endDate ='31-Dec-2013'
