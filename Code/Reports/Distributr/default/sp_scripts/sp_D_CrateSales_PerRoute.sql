---RETURNABLES SALES
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_D_CrateSales_PerRoute]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_D_CrateSales_PerRoute]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_D_CrateSales_PerRoute]
(
@startDate as date,
@endDate as date,
