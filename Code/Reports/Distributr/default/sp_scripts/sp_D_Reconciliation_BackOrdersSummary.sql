...
DROP PROCEDURE [dbo].[sp_D_Reconciliation_BackOrdersSummary]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_D_Reconciliation_BackOrdersSummary]
(
@startDate AS DATE,
@endDate AS DATE,
...
SELECT     orders.DocumentReference, 
           ...
           ordersItems.BackOrderQuantity,
           ordersItems.Quantity AS OrderedQuantity, 
...
WHERE     (orders.DocumentTypeId = 1) 
   ...
   --   Exec  [dbo].[sp_D_Reconciliation_BackOrdersSummary] @distributorId='ALL',@salesmanId='ALL',@countryId='ALL',@regionId='ALL',@routeId='ALL',@outletId='ALL',@brandId='ALL',@startDate = '1-jan-2013',@endDate = '30-dec-2013'
