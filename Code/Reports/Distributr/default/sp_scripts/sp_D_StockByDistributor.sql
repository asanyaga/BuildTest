/****** Object:  StoredProcedure [dbo].[sp_D_StockByDistributor]    Script Date: 07/24/2013 08:51:32 ******/
DROP PROCEDURE [dbo].[sp_D_StockByDistributor]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_D_StockByDistributor]
(
...
WHERE     (dbo.tblInventory.Balance >= 0) 
       ...
       -- Exec    [dbo].[sp_D_StockByDistributor]  @brandId='ALL', @distributorId='ALL',@salesManId='ALL',@productId='ALL',@packagingId='ALL',@Brand='ALL',@Product='ALL'
