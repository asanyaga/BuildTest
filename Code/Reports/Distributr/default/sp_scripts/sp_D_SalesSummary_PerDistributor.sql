/****** Object:  StoredProcedure [dbo].[sp_D_SalesSummary_PerDistributor]    Script Date: 07/24/2013 08:51:32 ******/
DROP PROCEDURE [dbo].[sp_D_SalesSummary_PerDistributor]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_D_SalesSummary_PerDistributor]
(
...
if  rtrim(ltrim(@salesmanId))='ALL'  begin set @salesmanId='%' end
                      ...
                      SELECT dbo.tblLineItems.id, 
                            ...
                            (tblLineItems.Quantity * tblLineItems.ProductDiscount)as TotalProductDiscount,
...
SELECT tblLineItems_1.id, 
       ...
       tblDocument_1.SaleDiscount,
        (tblLineItems_1.Quantity * tblLineItems_1.ProductDiscount)as TotalProductDiscount,
...
WHERE (tblDocument_1.DocumentTypeId = 1) 
   ...
   --  Exec [dbo].[sp_D_SalesSummary_PerDistributor] @startDate = '07-nov-2014',@endDate = '07-nov-2014',@distributorID ='ALL',@salesmanId = 'ALL'
