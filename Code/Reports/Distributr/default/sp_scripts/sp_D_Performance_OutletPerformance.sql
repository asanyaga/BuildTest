DROP PROCEDURE [dbo].[sp_D_Performance_OutletPerformance]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [sp_D_Performance_OutletPerformance]
(
...
where CONVERT(nvarchar(50),TargetPeriodIds)like ISNULL(@targetPeriodId,'%')
 ...
 GROUP BY CCID ,
        ...
        CountryIds,
        RegionIds ,
        RouteIds ,OutletName,TargetQuantity, TargetAmount,SalesQuantity,SalesAmount


-- EXEC  [sp_D_Performance_OutletPerformance] @countryId ='ALL',@regionId ='ALL',@distributorId ='ALL',@salesmanId ='ALL',@routeId ='ALL',@outletId ='ALL',@targetPeriodId ='6BA91756-73EF-45EF-AC69-B16098BA2049'  
