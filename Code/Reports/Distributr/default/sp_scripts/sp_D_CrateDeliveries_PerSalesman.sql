...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_D_CrateDeliveries_PerSalesman]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_D_CrateDeliveries_PerSalesman]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_D_CrateDeliveries_PerSalesman]
(
@startDate as date,
@endDate as date,
...
-- exec [dbo].[sp_D_CrateDeliveries_PerSalesman] @startDate ='2014-12-16',@endDate ='2014-12-16',@countryId ='ALL',@regionId='ALL',@distributorId='ALL',@salesmanId='ALL',@productId='A4E73902-E95C-4D5A-9820-7FAB4530A5BA'
