...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_D_SaleValueDiscount_sales]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_D_SaleValueDiscount_Sales]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[usp_D_SaleValueDiscount_Sales]
(
...
-- EXEC [dbo].[usp_D_SaleValueDiscount_sales] @startDate ='2014-06-01',@endDate ='2015-01-12',@distributorID=' ALL',@salesmanId=' ALL',@countryId=' ALL',@regionId=' ALL',@outletId=' ALL',@routeId=' ALL',@brandId=' ALL',@subBrandId=' ALL',@productId=' ALL',@productTypeId=' ALL'
