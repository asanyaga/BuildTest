---RETURNABLES SALES
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_D_CrateSales_PerRegion]') AND type in (N'P', N'PC'))

DROP PROCEDURE [dbo].[sp_D_CrateSales_PerRegion]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_D_CrateSales_PerRegion]
(
@startDate as date,
@endDate as date,
...
-- EXEC [dbo].[sp_D_CrateSales_PerRegion] @startDate='2015-05-01',@endDate='2015-05-12',@countryId=' ALL',@regionId=' ALL'
