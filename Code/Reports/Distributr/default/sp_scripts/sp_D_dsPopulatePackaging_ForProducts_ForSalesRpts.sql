DROP PROCEDURE [dbo].[sp_D_dsPopulatePackaging_ForProducts_ForSalesRpts]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_D_dsPopulatePackaging_ForProducts_ForSalesRpts]
(
...
WHERE CONVERT(nvarchar(50),prod.id) like ISNULL(@Product,'%')
AND prodPack.IM_Status = 1
ORDER BY PackagingName

-- Exec [dbo].[sp_D_dsPopulatePackaging_ForProducts_ForSalesRpts] @Product='ac2786d7-e998-47c5-b030-03d99944e002'
