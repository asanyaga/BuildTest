...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_D_CrateDeliveries_PerRoute]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_D_CrateDeliveries_PerRoute]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_D_CrateDeliveries_PerRoute]
(
@startDate as date,
@endDate as date,
...
-- exec [dbo].[sp_D_CrateDeliveries_PerRoute] @startDate ='2014-12-16',@endDate ='2014-12-16',@countryId ='ALL',@regionId='ALL',@distributorId='ALL',@salesmanId='ALL',@routeId='ALL',@productId='A4E73902-E95C-4D5A-9820-7FAB4530A5BA'
