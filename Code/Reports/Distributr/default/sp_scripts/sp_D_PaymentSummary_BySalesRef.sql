DROP PROCEDURE [dbo].sp_D_PaymentSummary_BySalesRef
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].sp_D_PaymentSummary_BySalesRef
(
@startDate as Date,
@endDate as Date,
...
if  ltrim(rtrim(@documentId))='ALL'  begin set @documentId='%' end
...
SELECT     Orders.Id AS OrderId, 
           ...
           dbo.tblLineItems.Receipt_PaymentReference as PaymenReference,
...
WHERE     (Orders.DocumentTypeId = 1) 
          ...
          AND (CONVERT(NVARCHAR(50), Orders.Id )LIKE ISNULL(@documentId,N'%'))
          
          
-- EXEC     sp_D_PaymentSummary_BySalesRef    @startDate='1-Jan-2014',@endDate='10-April-2014',@distributorId=' ALL',@salesmanId=' ALL',@routeId=' ALL',@outletId=' ALL',@documentId=' ALL'
