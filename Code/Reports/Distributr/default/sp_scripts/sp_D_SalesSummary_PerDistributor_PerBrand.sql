/****** Object:  StoredProcedure [dbo].[sp_D_SalesSummary_PerDistributor_PerBrand]    Script Date: 07/24/2013 08:51:32 ******/
DROP PROCEDURE [dbo].[sp_D_SalesSummary_PerDistributor_PerBrand]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_D_SalesSummary_PerDistributor_PerBrand]
(
...
WHERE (tblDocument_1.DocumentTypeId = 1) 
 ...
 --  Exec [dbo].[sp_D_SalesSummary_PerDistributor_PerBrand] @startDate = '25-July-2013',@endDate = '25-July-2013',@distributorID ='ALL',@salesmanId = 'ALL',@productTypeId='ALL'
