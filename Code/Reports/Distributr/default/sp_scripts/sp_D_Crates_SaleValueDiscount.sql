IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_D_Crates_SaleValueDiscount]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_D_Crates_SaleValueDiscount]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_D_Crates_SaleValueDiscount]
(
...
WHERE     (sale.OrderOrderTypeId = 1) 
 ...
 -- EXEC [dbo].[sp_D_Crates_SaleValueDiscount] @startDate='2014-12-01',@endDate='2014-12-22',@countryId=' ALL',@regionId=' ALL',@distributorId=' ALL',@salesmanId=' ALL',@routeId=' ALL',@outletId=' ALL',@docId=' ALL'
