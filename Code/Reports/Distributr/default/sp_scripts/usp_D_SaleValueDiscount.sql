...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_D_SaleValueDiscount]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_D_SaleValueDiscount]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[usp_D_SaleValueDiscount]
(
