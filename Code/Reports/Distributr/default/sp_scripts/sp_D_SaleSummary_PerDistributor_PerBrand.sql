/****** Object:  StoredProcedure [dbo].[sp_D_SaleSummary_PerDistributor_PerBrand]    Script Date: 07/24/2013 08:51:32 ******/
DROP PROCEDURE [dbo].[sp_D_SaleSummary_PerDistributor_PerBrand]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_D_SaleSummary_PerDistributor_PerBrand]
(
...
SELECT dbo.tblLineItems.id, dbo.tblLineItems.ProductID, dbo.tblLineItems.Description, dbo.tblDocument.DocumentTypeId, dbo.tblLineItems.Quantity, 
               ...
               dbo.tblProductBrand.name AS Brand,dbo.tblProductBrand.id AS BrandId,  dbo.tblLineItems.ProductDiscount, tblDocument.SaleDiscount,(dbo.tblLineItems.Quantity*dbo.tblLineItems.ProductDiscount)as TotalProductDiscount,
...
--Exec [dbo].[sp_D_SaleSummary_PerDistributor_PerBrand] @startDate = '22-July-2013',@endDate = '22-Aug-2013',@distributorID ='ALL',@salesmanId = 'ALL',@brandId='ALL',@productTypeId='ALL'
