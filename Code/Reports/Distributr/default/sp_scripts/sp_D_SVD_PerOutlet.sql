DROP PROCEDURE [dbo].[sp_D_SVD_PerOutlet]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_D_SVD_PerOutlet]
(
...
--  EXEC  [dbo].[sp_D_SVD_PerOutlet] @countryId='ALL' ,@regionId='ALL' ,@distributorId='ALL' ,@salesmanId='ALL' ,@outletId='ALL' ,@startDate='2014-06-01',@endDate='2014-06-06'
