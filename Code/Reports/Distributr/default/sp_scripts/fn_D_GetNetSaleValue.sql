DROP FUNCTION [dbo].[fn_D_GetNetSaleValue] 
GO


CREATE FUNCTION [dbo].[fn_D_GetNetSaleValue] 
(
...
-- SELECT [dbo].[fn_D_GetNetSaleValue] (NULL, '6466992D-B8DC-4E64-81A9-FD90D8497577','2013-11-18')
--  select dbo.fn_D_GetNetSaleValue(NULL,NULL,'2013-11-18')
