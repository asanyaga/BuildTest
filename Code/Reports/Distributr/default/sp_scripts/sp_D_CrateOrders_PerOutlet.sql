---RETURNABLES ORDERS
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_D_CrateOrders_PerOutlet]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_D_CrateOrders_PerOutlet]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_D_CrateOrders_PerOutlet]
(
@startDate as date,
@endDate as date,
...
-- EXEC [dbo].[sp_D_CrateOrders_PerOutlet] @startDate='2014-12-01',@endDate='2014-12-22',@countryId=' ALL',@regionId=' ALL',@distributorId=' ALL',@salesmanId=' ALL',@routeId=' ALL',@outletId=' ALL'