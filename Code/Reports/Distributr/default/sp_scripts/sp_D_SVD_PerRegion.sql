DROP PROCEDURE [dbo].[sp_D_SVD_PerRegion]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_D_SVD_PerRegion]
(
...
--  EXEC  [dbo].[sp_D_SVD_PerRegion] @countryId='ALL' ,@regionId='ALL' ,@startDate='2014-06-01',@endDate='2014-06-06'
