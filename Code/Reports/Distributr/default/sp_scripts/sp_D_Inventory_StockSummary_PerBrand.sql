/****** Object:  StoredProcedure [dbo].[sp_D_Inventory_StockSummary_PerBrand]    Script Date: 07/24/2013 08:51:32 ******/
DROP PROCEDURE [dbo].[sp_D_Inventory_StockSummary_PerBrand]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_D_Inventory_StockSummary_PerBrand]
(
...
-- Exec   [dbo].[sp_D_Inventory_StockSummary_PerBrand]  @distributorId='ALL',@salesmanId='ALL',@brandId='ALL',@productId='ALL',@packagingId='ALL',@productTypeId='ALL'          
