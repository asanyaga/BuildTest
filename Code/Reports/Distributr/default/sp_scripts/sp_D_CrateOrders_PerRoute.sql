---RETURNABLES ORDERS
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_D_CrateOrders_PerRoute]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_D_CrateOrders_PerRoute]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_D_CrateOrders_PerRoute]
(
@startDate as date,
@endDate as date,
...
-- EXEC [dbo].[sp_D_CrateOrders_PerRoute] @startDate='2015-01-01',@endDate='2015-01-16',@countryId=' ALL',@regionId=' ALL',@distributorId=' ALL',@salesmanId=' ALL',@routeId=' ALL'
