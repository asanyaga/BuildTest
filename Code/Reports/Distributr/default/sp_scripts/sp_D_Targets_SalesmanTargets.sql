...
DROP PROCEDURE [dbo].[sp_D_Targets_SalesmanTargets]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [sp_D_Targets_SalesmanTargets]
...
select CCID SalesmanId,
       DistributorName SalesmanName,
       TargetPeriodIds,
       TargetPeriodName,
       TargetStartDate,
       TargetEndDate,
...
where CONVERT(nvarchar(50),TargetPeriodIds) like ISNULL(@targetPeriodId,'%')
  ...
  -- EXEC  [dbo].[sp_D_Targets_SalesmanTargets] @countryId ='ALL',@regionId ='ALL',@distributorId='E8C61376-8FD2-46B8-B293-952D7B86F54F',@salesmanId='ALL',@targetPeriodId ='ALL'
