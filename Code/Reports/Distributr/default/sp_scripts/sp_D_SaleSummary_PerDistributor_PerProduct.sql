DROP PROCEDURE [dbo].[sp_D_SaleSummary_PerDistributor_PerProduct]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_D_SaleSummary_PerDistributor_PerProduct]
(
...
--Exec [dbo].[sp_D_SaleSummary_PerDistributor_PerProduct] @startDate = '22-July-2013',@endDate = '22-Aug-2013',@distributorID ='ALL',@salesmanId = 'ALL',@brandId='ALL',@productTypeId='ALL',@subBrandId='ALL'
