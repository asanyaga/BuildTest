...
DROP PROCEDURE [dbo].[sp_D_PaymentSummary_Per_Distributor]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_D_PaymentSummary_Per_Distributor]
(
@startDate as Date,
@endDate as Date,
...
WHERE     (Orders.DocumentTypeId = 1) 
  ...
  -- Exec   [dbo].[sp_D_PaymentSummary_Per_Distributor] @distributorId='ALL',@startDate='25-Mar-2015',@endDate='25-Mar-2015'
