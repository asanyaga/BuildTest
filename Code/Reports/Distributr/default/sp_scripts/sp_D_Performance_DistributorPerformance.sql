DROP PROCEDURE [dbo].[sp_D_Performance_DistributorPerformance]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [sp_D_Performance_DistributorPerformance]
...
--    EXEC  [dbo].[sp_D_Performance_DistributorPerformance] @countryId ='ALL',@regionId ='ALL',@distributorId='ALL',@targetPeriodId ='ALL'
