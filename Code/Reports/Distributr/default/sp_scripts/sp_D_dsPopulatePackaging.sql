DROP PROCEDURE [dbo].[sp_D_dsPopulatePackaging]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_D_dsPopulatePackaging]
(
...
-- Exec [dbo].[sp_D_dsPopulatePackaging] @productId='ac2786d7-e998-47c5-b030-03d99944e002'
