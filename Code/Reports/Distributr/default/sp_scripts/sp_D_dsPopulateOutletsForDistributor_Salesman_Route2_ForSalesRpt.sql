DROP PROCEDURE [dbo].[sp_D_dsPopulateOutletsForDistributor_Salesman_Route2_ForSalesRpt]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_D_dsPopulateOutletsForDistributor_Salesman_Route2_ForSalesRpt]
(
...
ORDER BY OutletName asc
 ...
 -- Exec  [dbo].[sp_D_dsPopulateOutletsForDistributor_Salesman_Route2_ForSalesRpt] @distributorID='ALL',@salesmanId='ALL',@routeId='ALL'
