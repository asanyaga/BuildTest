---RETURNABLES SALES
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_D_CrateSales_PerSalesman]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_D_CrateSales_PerSalesman]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_D_CrateSales_PerSalesman]
(
@startDate as date,
@endDate as date,
...
-- EXEC [dbo].[sp_D_CrateSales_PerSalesman ] @startDate='2015-03-05',@endDate='2015-03-06',@countryId=' ALL',@regionId=' ALL',@distributorId=' ALL',@salesmanId=' ALL'
