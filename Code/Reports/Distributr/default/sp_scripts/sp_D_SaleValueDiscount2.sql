...
DROP PROCEDURE [dbo].[sp_D_SaleValueDiscount2]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_D_SaleValueDiscount2]
(
...
WHERE     (DocumentTypeId = 1) 
 ...
 --  Exec [dbo].[sp_D_SaleValueDiscount2] @startDate ='1-May-2014',@endDate ='15-May-2014',@distributorId = 'ALL',@salesmanId = 'ALL'
