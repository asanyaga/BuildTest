IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'sp_A_DepositorDetails')
   exec('CREATE PROCEDURE [sp_A_DepositorDetails] AS BEGIN SET NOCOUNT ON; END')
GO
Alter PROCEDURE sp_A_DepositorDetails
(
...
-- EXEC sp_A_DepositorDetails @DocumentId = '394866F3-5CF2-47B5-9533-DC4A582E34F7'
