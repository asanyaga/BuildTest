IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'sp_A_ServiceProviderDetailsSummary')
   exec('CREATE PROCEDURE [sp_A_ServiceProviderDetailsSummary] AS BEGIN SET NOCOUNT ON; END')
GO
Alter PROCEDURE sp_A_ServiceProviderDetailsSummary
(
@StartDate AS DATE,
@EndDate AS DATE,
...
-- EXEC sp_A_ServiceProviderDetailsSummary @StartDate='2015-06-01',@EndDate='2015-07-15',@HubId='ALL',@RouteId='ALL',@CentreId='ALL',@FarmerId='ALL',@FarmId='ALL',@ActivityId='ALL',@ClerkId='ALL'
