IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'sp_A_WarehouseReceiptTransactions')
   exec('CREATE PROCEDURE [sp_A_WarehouseReceiptTransactions] AS BEGIN SET NOCOUNT ON; END')
GO
Alter PROCEDURE sp_A_WarehouseReceiptTransactions
(
@StartDate AS DATE,
@EndDate AS DATE,
...
-- EXEC sp_A_WarehouseReceiptTransactions @StartDate='2015-06-01',@EndDate='2015-07-23',@HubId='ALL',@ClerkId='ALL',@CountryId='ALL',@LocationId='ALL',@DepositorId='ALL',@StoreId='ALL',@CommodityId='ALL',@GradeId='ALL'
