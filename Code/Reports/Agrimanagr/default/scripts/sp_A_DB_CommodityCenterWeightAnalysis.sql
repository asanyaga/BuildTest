DROP PROCEDURE [dbo].[sp_A_DB_CommodityCenterWeightAnalysis]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_A_DB_CommodityCenterWeightAnalysis]
(
...
if  @regionId='ALL'  begin set @regionId='%' end
 ...
 -- Exec [dbo].[sp_A_DB_CommodityCenterWeightAnalysis] @startDate='2013-10-16',@endDate='2013-10-16',@regionId='ALL'
