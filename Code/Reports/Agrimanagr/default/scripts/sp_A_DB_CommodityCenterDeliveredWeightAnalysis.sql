DROP PROCEDURE [dbo].[sp_A_DB_CommodityCenterDeliveredWeightAnalysis]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[sp_A_DB_CommodityCenterDeliveredWeightAnalysis]
(
...
if  @regionId='ALL'  begin set @regionId='%' end
  ...
  SELECT DISTINCT 
          ...
          item.Weight AS DeliveredWeight
 ...
 -- Exec [dbo].[sp_A_DB_CommodityCenterDeliveredWeightAnalysis] @startDate='2013-10-16',@endDate='2013-10-16',@regionId='ALL'
