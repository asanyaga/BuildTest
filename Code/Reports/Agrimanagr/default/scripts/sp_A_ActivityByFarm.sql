IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'sp_A_ActivityByFarm')
   exec('CREATE PROCEDURE [sp_A_ActivityByFarm] AS BEGIN SET NOCOUNT ON; END')
GO
Alter PROCEDURE sp_A_ActivityByFarm
(
@StartDate AS DATE,
@EndDate AS DATE,
