IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'sp_A_ShiftByFarm')
   exec('CREATE PROCEDURE [sp_A_ShiftByFarm] AS BEGIN SET NOCOUNT ON; END')
GO
Alter PROCEDURE sp_A_ShiftByFarm
(
@StartDate AS DATE,
@EndDate AS DATE,
