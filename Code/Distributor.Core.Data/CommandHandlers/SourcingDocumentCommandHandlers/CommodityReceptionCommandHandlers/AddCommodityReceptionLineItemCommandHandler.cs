...
{
    public class AddCommodityReceptionLineItemCommandHandler :BaseSourcingCommandHandler, IAddCommodityReceptionLineItemCommandHandler
    {
        
        ILog _log = LogManager.GetLogger("AddCommodityReceptionLineItemCommandHandler");


        public AddCommodityReceptionLineItemCommandHandler(CokeDataContext context) : base(context)
        {
        }

        public void Execute(AddCommodityReceptionLineItemCommand command)
        {
            ...
            catch (Exception ex)
            {
                ...
                _log.Error("AddCommodityReceptionLineItemCommandHandler exception", ex);
                throw;
            }
        }
    }
