;with cte as (select  o.Id, 
 ...
 (select ISNULL(sum(rl.Value ),0)
  ...
  o.DocumentStatusId,
  tli.LineItemStatusId
 from tblDocument o
 join tblLineItems tli on tli.DocumentID = o.Id
where o.DocumentTypeId = 1
and tli.LineItemStatusId = 4
 ...
 select DISTINCT *,NetAmount - (c.ReceiptAmount  + c.CreditAmount) as OutstandingAmount from cte c  