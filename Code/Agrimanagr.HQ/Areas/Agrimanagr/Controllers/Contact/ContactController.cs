...
namespace Agrimanagr.HQ.Areas.Agrimanagr.Controllers.Contact
{
    ...
    public class ContactController : Controller
    {
        ...
        ICommoditySupplierViewModelBuilder _commoditySupplierViewModelBuilder;
       ...
       // ICostCentreViewModelBuilder _costCentreViewModelBuider;
        public ContactController(IContactViewModelBuilder contactModelViewBuilder,IAuditLogViewModelBuilder auditLogViewModelBuilder,IUserViewModelBuilder userViewModelBuilder,IDistributorViewModelBuilder distributorViewModelBuilder,IOutletViewModelBuilder outletViewModelBuilder, ICommoditySupplierViewModelBuilder commoditySupplierViewModelBuilder)
        {
        ...
        public ActionResult ListSupplierContacts(bool? showInactive, Guid? CostCentre, int? ContactOwner, int itemsperpage = 10, int page = 1, string searchParam = "")
        {
        ...
        private Dictionary<int,string> AcceptedContactOwnerTypes()
        {
            ...
            var keysToRemove = new List<ContactOwnerType>() { ContactOwnerType.Distributor, ContactOwnerType.Outlet };
