...
{
    public class AddCommodityTransferLineItemCommand : AfterCreateCommand
    {
        public AddCommodityTransferLineItemCommand()
        {
        }
        ...
        {
            get { return CommandType.AddCommodityTransferLineItem.ToString(); }
        }
    }
}
