...
namespace Distributr.Core.Factory.SourcingDocuments
{
    public interface ICommodityWarehouseStorageFactory
    {
        ...
        CommodityWarehouseStorageLineItem CreateLineItem(Guid parentId, Guid commodityId, Guid gradeId, Guid containerId, string containerNo, decimal weight, string description);
    }
}