...
namespace Distributr.Core.Factory.SourcingDocuments.Impl
{
    public class CommodityWarehouseStorageFactory : BaseSourcingDocumentFactory, ICommodityWarehouseStorageFactory
    {
        ...
        public CommodityWarehouseStorageLineItem CreateLineItem(Guid parentId, Guid commodityId, Guid gradeId, Guid containerTypeId, string containerNo, decimal weight, string description)
        {
