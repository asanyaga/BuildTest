        ...
        private void SaveMasterData(MasterEntity entity, MasterDataDTOSaveCollective collective)
        {
            switch (collective)
            {
                ...
                case MasterDataDTOSaveCollective.MasterDataAllocation:
                    if(entity != null && entity is MasterDataAllocation)
                    {
                        _masterDataAllocationRepository.Save(entity as MasterDataAllocation);
                    }
                    break;
                default:
                    break;
