...
namespace Distributr.HQ.Web.Areas.Admin.Controllers.BanksControllers
{
    [Authorize ]
    ...
    { 
        ...
        public ActionResult ListBanks(bool? showInactive, string searchText, int itemsperpage = 10, int page = 1)
        {
            try
            {
                ...
                var result = _bankViewModelBuilder.Query(query);
