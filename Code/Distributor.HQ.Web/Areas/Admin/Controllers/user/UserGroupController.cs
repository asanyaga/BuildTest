...
namespace Distributr.HQ.Web.Areas.Admin.Controllers.user
{
    ...
    { 
        ...
        public UserGroupController(IUserGroupVeiwModelBuilder userGroupVeiwModelBuilder, IUserGroupRoleVeiwModelBuilder userGroupRoleVeiwModelBuilder,IAuditLogViewModelBuilder auditLogViewModelBuilder)
        {
        ...
        public ActionResult Assign(Guid Id)
        {
            ...
            return View( _userGroupVeiwModelBuilder.GetRoles(Id));
         ...
         public ActionResult Assign(string[] cb, string groupId)
         {
             try
             {
                 ...
                 _userGroupVeiwModelBuilder.Save(cb,id);
