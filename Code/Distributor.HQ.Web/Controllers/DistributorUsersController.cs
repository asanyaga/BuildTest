...
namespace Distributr.HQ.Web.Controllers
{
    ...
    public class DistributorUsersController : Controller
    {
        ...
        public DistributorUsersController(IUserViewModelBuilder userViewModelBuilder, IAuditLogViewModelBuilder auditLogViewModelBuilder)
        {
        ...
        public ActionResult ListAllUsers(bool? showInactive, string searchText, int itemsperpage = 10, int page = 1)
        {
            try
            {
                ...
                var result = _userViewModelBuilder.DistributorQuery(query);
